...
(function(){
  ...
  const T = {
    ...
    "Roster is short today":"今天排班人手不够",
    ...
    "rostered":"已排", "total":"合计", "warnings":"提醒", "all clear":"一切正常",
    ...
    "On hand":"现有", "Est. cost":"预计花费",
    "needs 2 counts":"需要两次盘点",
    ...
    "Expected":"待收货", "Short delivered":"少送", "Damaged":"破损", "Wrong item":"送错货",
    ...
    "Turned away":"已拒收", "System count":"系统数", "Stocktake saved":"已盘点",
    "Good condition":"完好",
    ...
    "SOP library":"SOP 库", "Training status":"培训进度", "Assigned training":"已派培训",
    "Outstanding":"未完成", "Overdue":"已逾期", "Due soon":"即将到期", "Assigned":"已派发",
    "Person":"人员", "Due":"截止", "Status":"状态", "Signed off":"签字确认",
    ...
    "Can open":"会开店", "Can close":"会关店", "Front of house":"前厅", "Coffee / bar":"咖啡 / 吧台", "Can run a shift":"能带班",
    ...
    "Clear read alerts":"清除已读提醒", "Delete all alerts already marked read?":"删除所有已标为已读的提醒？",
    ...
    "Can't reach the sign-in service — check your connection and try again":"无法连接登录服务 —— 请检查网络后重试",
    ...
    "Fold the menu":"收起菜单", "Open the menu":"展开菜单",
    // ---- Owner home · the springboard of blocks ----
    "⬛ Blocks":"⬛ 方块",
    "The pages you use, one tap away":"你常用的页面，一点就到",
    "Tap Edit to add, drop or re-order the blocks.":"点“编辑”可以增减方块、调整顺序。",
    "No tiles yet — hit Edit and add the pages you open most.":"主页还是空的 —— 点“编辑”，把你最常开的页面加进来。",
    "Add a tile":"添加一块",
    "Every page is already on your home screen":"所有页面都已经在主页上了",
    "Added to your home screen":"已加到主页",
    "Daily tasks":"每日任务",
    ...
    "Today's overview":"今日概览", "Tasks due today":"今日待办任务", "Deliveries today":"今日到货",
    ...
    "48 hours is the standard student-visa fortnight and is filled in below for anyone whose recorded visa is a subclass 500.":"48 小时是学生签证两周的标准上限，凡是签证记录为 500 类的人下面都已经预填。",
    "Check it.":"请你自己核对。",
    "Conditions change, scheduled course breaks are an exception, and this app does not read anyone\u2019s visa — it counts your roster against the number you save here.":"条件会变、放假期间是例外，而且本应用不读任何人的签证 —— 它只是拿你的排班去比你在这里保存的那个数。",
    "no limit":"不限", "h / 14 days":"小时 / 14 天",
    "Warn me when a fortnight goes over":"两周超了就提醒我",
    "Turn this off and the numbers above are still recorded, just never mentioned.":"关掉之后上面的数字照样存着，只是不再提醒。",
    "5 · Who can do what?":"5 · 谁能做什么？",
    "Fortnightly hour limit":"两周工时上限",
    "None recorded — set it in Rostering → Preferences":"未记录 —— 到「排班 → 偏好设置」填",
    "Public holiday":"公共假日",
    // Certificates
    "Certificates & work rights":"证件与工作权利", "My certificates":"我的证件",
    "Add a certificate":"添加证件", "Certificate":"证件",
    "Whose is it":"这是谁的", "What it is":"是什么证",
    "Name it":"证件名称", "Certificate number (optional)":"证件编号（选填）",
    "Expires":"到期日", "Photo of the certificate":"证件照片",
    "Tap to upload":"点击上传",
    "RSA — Responsible Service of Alcohol":"RSA — 负责任售酒证",
    "Food Safety Supervisor":"食品安全监督员（FSS）",
    "Food handler certificate":"食品操作人员证", "First aid / CPR":"急救 / CPR",
    "White card":"白卡（建筑安全证）", "Other":"其他",
    "No expiry":"无到期日", "no expiry recorded":"未填到期日",
    "Recorded so it can be produced on the spot and so you get told before it lapses. Nothing here is verified with the issuing body, and the app makes no judgement about whether the venue is compliant.":"记下来，是为了检查时能当场拿出来，也为了到期前提醒你。本应用不向发证机构核验，也不判断门店是否合规。",
    "Dates and photos as recorded by the venue and its staff. Nothing here is checked with an issuing body, and the app makes no judgement about whether anyone is compliant or entitled to work.":"日期和照片都是门店与员工自己录入的。本应用不向发证机构核验，也不判断任何人是否合规、是否有工作资格。",
    "Nothing recorded yet. RSA, Food Safety Supervisor and work rights are the three an inspector asks for.":"还没录入。检查员最常要的三样是：RSA、食品安全监督员（FSS）、工作权利。",
    "Work rights — visa":"工作权利 — 签证", "from their onboarding":"来自他的入职资料",
    "Certificate expired":"证件已过期", "Certificate expiring":"证件即将到期",
    "Certificate recorded":"证件已记录", "Certificate updated":"证件已更新",
    "Remove certificate":"删除证件", "Give it a name":"给它起个名字",
    "Whose certificate is it?":"这是谁的证件？",
    "Recorded, not interpreted. The app never reads what your visa allows — if the venue needs that verified they use VEVO themselves. If your visa limits your hours, your manager records that limit separately and the roster warns them before they go over it; nothing here stops you working.":"只记录，不解读。本应用从不判断你的签证允许什么 —— 门店要核验的话，他们自己上 VEVO。如果你的签证限制工时，你的经理会另外把这个上限记下来，排班超了会提醒他；这里不会阻止你上班。",
    ...
    "Stocktake":"盘点", "Export CSV":"导出 CSV",
    "Shelf":"货架",
    "Preferences":"偏好设置", "Export":"导出", "AI auto-roster":"AI 自动排班",
    "Today":"今天", "Change password":"修改密码", "Log out":"退出登录",
    ...
    "Kitchen":"后厨", "Today's checklist":"今日任务",
    "Staff area":"员工区", "Roster for the week":"本周排班",
    "Training room":"培训室", "Sign-offs waiting":"待签字",
    "Your office":"老板办公室", "Alerts and the week":"提醒与本周",
    "Waiting to be confirmed at the back door":"在收货口等你确认",
    "Cleaning, prep and temperature checks":"清洁、备料与温度检查",
    "Fewer people on than you planned":"在岗人数比你排的少",
    "Staff still to sign off":"员工还没签字",
    "Unread alerts":"未读提醒",
    "Start here":"从这里开始", "All done for today":"今天全部搞定",
    ...
    "Your kitchen":"你的后厨", "Tap the station you're standing at":"点你正站着的那个工位",
    "Fridges & cold room":"冰箱与冷库", "Temperatures and stock":"温度与存货",
    "Range & hood":"炉灶与油烟机", "Stove, oven, fryer, filters":"灶台、烤箱、炸炉、滤网",
    "Prep bench":"备料台", "Prep, portioning, labels":"备料、分装、贴标",
    "Sink & dishes":"水槽与洗碗", "Washing up and glassware":"洗碗与玻璃器皿",
    "Floor & bins":"地面与垃圾", "Mopping, rubbish, deep clean":"拖地、倒垃圾、大扫除",
    "Pass & everything else":"出餐口与其他", "Whatever is left on the list":"清单上剩下的",
    "Every tick writes to the same checklist the kitchen sees on their phone.":"这里打的每个勾，都写进厨房手机上看到的同一份清单。",
    "No tasks published for today yet.":"今天还没有发布任务。",
    "Ticking here is the same action as ticking on the phone — it records who did it and when.":"在这里打勾和在手机上打勾是同一个动作 —— 会记下是谁、什么时候做的。",
    "Not done yet":"还没做", "Temperature check":"温度检查", "Type the reading":"请填写读数",
    // ---- Stock · the numbers a jar used to carry, now read on the list ----
    "need topping up":"需要补货", "on the shelves":"货架总值",
    "Days of cover":"还能撑几天", "Used per day":"每天用量", "Last price paid":"最近采购价",
    "not set":"未设置", "Record it":"确认记录",
    // ---- Calendar ----
    "Calendar":"日历",
    "Deliveries, pest control, the deep clean — who is doing what, and when":"到货、灭虫、大扫除 —— 谁在做什么，什么时候做",
    "Add to the calendar":"加进日历", "Export .ics":"导出 .ics", "Import .ics":"导入 .ics",
    "What is it":"是什么事", "Kind":"类型", "Who is doing it":"谁来做",
    "Date":"日期", "Time — optional":"时间 —— 可不填", "Repeat":"重复",
    "Repeat until — optional":"重复到 —— 可不填", "Note — optional":"备注 —— 可不填",
    "Goods arriving":"到货", "Pest control":"灭虫", "Deep clean":"大扫除",
    "Maintenance":"维修保养", "Something else":"其他",
    "Does not repeat":"不重复", "Weekly":"每周", "Fortnightly":"每两周",
    "Monthly":"每月", "Every quarter":"每季度",
    "Added to the calendar":"已加进日历", "Removed":"已移除",
    "No events found in that file":"这个文件里没有日程",
    "Nothing on the calendar to export":"日历上没有可导出的内容",
    "Deliveries come from the Deliveries page — change a date there and it changes here. Everything else on this calendar is yours.":"到货来自「到货」页 —— 在那边改日期，这里跟着变。日历上其余的都是你自己加的。",
    "Expected on":"预计到货日", "Expected time — optional":"预计时间 —— 可不填",
    // ---- Stock · an item can carry a photo ----
    "Photo — optional":"照片 —— 可不填", "Take a photo or pick one":"拍一张，或从相册选",
    "Remove photo":"删掉照片",
    // ---- Setup · the photo the AI reads, and the pictures on the home screen ----
    "Have it on paper? Photograph it.":"有纸质的？拍下来。",
    "A menu, a business card, a supplier invoice, the staff list on the wall — the AI reads it and fills in what it can see below. Check it before you finish; it fills blanks, it never overwrites what you typed.":"菜单、名片、供应商发票、墙上的排班表 —— AI 读一遍，能认出来的直接填到下面。填完自己核对一下；它只填空白，不会覆盖你已经写的。",
    "Read a photo":"读一张照片", "Reading…":"识别中…",
    "Add banner":"加背景图", "Change banner":"换背景图",
    "Picture saved":"图片已保存", "Picture removed":"图片已删除",
    "Drag to move · − to take one off · ":"拖动排序 · 按 − 移除 · 按 ",
    "to set a picture":"设置图片",
    // ---- Staff · the stock count ----
    "Stock count":"盘点库存", "Count":"盘点",
    "Walk the shelves and type what is actually there":"走一遍货架，把实际数量填上",
    "Type only what you counted — anything left blank is skipped, so you can do the cold room now and the dry store later.":"只填你数过的 —— 空着的会跳过，所以可以先点冷库，晚点再点干货区。",
    "Everything else":"其他", "Everything on the shelf":"货架上的全部",
    "Type at least one count":"至少填一项",
    "Nothing to count yet — the venue hasn't added any stock items.":"暂时没有可点的东西 —— 店里还没添加库存物品。",
    "Stock count (staff can count)":"盘点库存（员工可点）",
    "Upload your logo":"上传你的 logo", "Logo saved":"logo 已保存",
    "Logo saved · colour picked up from it":"logo 已保存 · 主色已从中提取",
    // ---- Deliveries · a week at a time, and the docket photos ----
    "Coming up":"接下来", "what to expect at the back door, week by week":"后门要收的货，一周一周排",
    "Photos of the docket or the problem":"送货单或问题的照片",
    "Photos of the docket or the problem (optional)":"送货单或问题的照片（可不填）",
    "Photo of the problem — at least one is required":"问题照片 —— 至少要一张",
    "Add photos":"添加照片", "No photos yet":"还没有照片",
    "Read the docket":"识别送货单",
    "Couldn't read that docket — type it in":"这张送货单没读出来 —— 手动填吧",
    "Where you are now — the whole venue":"你现在在这里 —— 整个店",
    "Roster, tasks, stock, deliveries, adding people":"排班、任务、库存、收货、加人",
    "Shifts, clock-in, today's tasks, training":"排班、打卡、今日任务、培训",
    // ---- First-run setup ----
    "1 · Your restaurant":"1 · 你的餐厅", "2 · Who works here":"2 · 店里有谁",
    "3 · Who you buy from":"3 · 供应商", "4 · What you keep in stock":"4 · 常备库存",
    "5 · Choose your features":"5 · 选择功能",
    "Fill this in once and the app is yours: your venue, your people, your suppliers, your shelf. Everything here can be changed later.":"填一次，这个 App 就是你的了：门店、员工、供应商、库存。这里填的以后都能改。",
    "Suburb / branch":"区域 / 分店", "Opens":"开门", "Closes":"打烊",
    "Add another":"再加一行", "Finish setup":"完成设置",
    "Your restaurant needs a name":"餐厅得有个名字",
    // ---- Stock · adding a list of items ----
    "🏷️ Prices":"🏷️ 菜价",
    "Add items":"批量添加", "Add stock items":"批量添加库存物品",
    "Check before it saves":"保存前先核对一下",
    "Or tap a common one to add it to the list":"或者点常用项，直接加进上面的清单",
    "One at a time instead":"改成一个一个加", "Add them":"全部添加",
    "Type a list first — one thing per line":"先写个清单 —— 一行一样东西",
    "Fresh":"生鲜", "Protein":"荤菜", "Dry store":"干货", "Consumables":"耗材",
    "Name":"名称", "Type":"类型", "Qty":"数量", "Unit":"单位", "Price":"单价", "Reorder at":"补货线",
    "needs a name":"需要填名字",
    "Reorder point is a starting guess (about a third of what you're holding) — change it here or later, it's what decides when an item turns red.":"补货线先按现有量的三分之一估一个 —— 现在改或以后改都行，它决定这项什么时候变红。",
    // ---- Purchases · the dockets ----
    "dockets kept":"存档小票", "spent this month":"本月支出",
    "vs the same days last month":"对比上月同期", "average docket":"单张平均",
    "Every supplier":"全部供应商", "Every month":"全部月份",
    "Search an item or a docket number":"搜物品名或小票号",
    "Nothing matches that.":"没有匹配的。",
    "🧾 Docket":"🧾 小票", "Print":"打印", "Record purchase":"录入采购", "Save docket":"保存小票",
    "GOODS RECEIVED · your own record":"收货记录 · 你自己的存档",
    "Supplier":"供应商", "Docket":"小票号", "Delivered":"送达时间", "Paid by":"付款方式",
    "Goods":"货款", "Freight":"运费", "GST on the docket":"小票上的 GST", "TOTAL":"合计",
    "Not a tax invoice · your own record of what you paid":"这不是税务发票 · 只是你自己的付款存档",
    "first time on a docket":"第一次出现在小票上",
    "Delivered on":"送达日期", "Freight / delivery fee":"运费 / 配送费",
    "GST shown on the docket":"小票上写的 GST", "Docket total":"小票合计",
    "Photo of the docket (optional)":"小票照片（可不填）",
    "Bank transfer":"银行转账", "Card":"刷卡", "Cash":"现金",
    "Saving adds these quantities to stock, updates each item's unit price and files the docket. Type only what the paper says — the app works nothing out for tax.":"保存后会把数量加进库存、更新单价，并把这张小票存档。纸上写什么就填什么 —— 税务的事这个 App 一概不算。",
    "Docket filed · stock topped up":"小票已存档 · 库存已补上",
    // ---- Prices · week against week ----
    "Week":"本周", "Fortnight":"两周", "Month":"本月",
    "Last week":"上周", "This week":"本周",
    "Last fortnight":"上两周", "This fortnight":"这两周",
    "Last month":"上月", "This month":"本月",
    "spent this week":"本周支出", "the week before":"上周支出",
    "spent this fortnight":"这两周支出", "the fortnight before":"上两周支出",
    "the month before":"上月支出",
    "went up":"涨价", "came down":"降价",
    "📈 What moved":"📈 有变动的",
    "ordered by what the move cost you, not by percent":"按多花的钱排序，不是按百分比",
    "➖ Held their price":"➖ 价格没动",
    "🆕 No comparison yet":"🆕 还没法比",
    "Move":"涨跌", "Cost to you":"多花/少花", "Trend":"走势",
    "— held":"— 持平", "first time":"第一次买",
    "Not enough dockets to compare yet.":"存的小票还不够比。",
    "Your shopping got dearer this week.":"这周进货变贵了。",
    "Your shopping got cheaper this week.":"这周进货便宜了。",
    "Prices held steady this week.":"这周价格没怎么动。",
    "Your shopping got dearer this fortnight.":"这两周进货变贵了。",
    "Your shopping got cheaper this fortnight.":"这两周进货便宜了。",
    "Prices held steady this fortnight.":"这两周价格没怎么动。",
    "Your shopping got dearer this month.":"这个月进货变贵了。",
    "Your shopping got cheaper this month.":"这个月进货便宜了。",
    "Prices held steady this month.":"这个月价格没怎么动。",
    "No change overall.":"总体没变化。",
    // ---- Suppliers ----
    "Who you ask for":"找谁", "Delivers":"送货日", "Order by":"下单截止",
    "Minimum order":"起送金额", "Payment terms":"账期", "Account no.":"账号", "Address":"地址",
    "dockets":"张小票", "spent with them":"累计采购", "last delivery":"最近一次送货",
    "dearer this month":"本月涨价项",
    "🛒 Build their order":"🛒 生成给他的订单",
    "Copy as a message":"复制成一段话",
    "Copied — paste it into a text or email":"已复制 —— 粘到短信或邮件里就行",
    "Could not copy on this device":"这台设备复制不了",
    "Website":"网站", "Delivery days":"送货日", "Order by (cut-off)":"下单截止时间",
    "Minimum order (AUD)":"起送金额（澳元）", "Your account no.":"你的账号",
    "Point your stock items at a supplier and the two link up: their card lists what they bring, and every order groups itself by who to ring.":"给库存物品选好供应商，两边就连起来了：供应商卡片会列出他家送的东西，订单也会自动按“该打给谁”分组。",
    "No suppliers yet. Add the people you actually ring when you need stock — name, phone, what they bring and when they deliver.":"还没有供应商。把你真正会打电话的那几家加进来 —— 名字、电话、送什么、什么时候送。",
    "No stock items point at this supplier yet — set one on the item and it shows up here.":"还没有库存物品选这家供应商 —— 在物品里设一下就会出现在这里。",
    "Mon":"周一","Tue":"周二","Wed":"周三","Thu":"周四","Fri":"周五","Sat":"周六","Sun":"周日",
    // ---- Forecast · showing the working ----
    "Nothing here is guessed — it's your stocktakes, added up.":"这里没有一个数是猜的 —— 都是你的盘点加出来的。",
    "counted last time + everything the dockets brought in − counted this time = used":"上次盘点 + 小票上进的货 − 这次盘点 = 用掉的",
    "tap a row to see its working":"点一行看它是怎么算出来的",
    "Suggested order = enough to cover the delivery lead time plus a week, less what's already on the shelf. With no usage history yet it falls back to twice your reorder point.":"建议订量 = 够撑到下次送货再加一周，减去货架上已有的。还没有用量记录时，就按补货线的两倍来。",
    "Between two counts":"两次盘点之间", "Bought":"期间进货", "Used":"用掉", "Per day":"每天",
    "Averaged":"平均下来", "On hand":"现有", "Used / day":"每天用量",
    "Suggest order":"建议订量", "Est. cost":"预计花费", "no usage data yet":"还没有用量数据",
    "Every interval had to be skipped, so there's no usable rate yet. The reasons are listed above.":"每一段都被跳过了，所以还算不出可用的用量。原因见上表。",
    "Tap Ask AI for a plain-English read on what to order and what's creeping up in price.":"点“问 AI”，用大白话说说该订什么、什么在悄悄涨价。",
    "Every figure is the price you actually paid, weighted by quantity, taken straight off your dockets. Nothing here is a market rate or a forecast of one.":"这里每个数字都是你实际付过的价，按数量加权，直接来自你的小票。不是市场行情，也不是对行情的预测。",
    // ---- Deliveries ⇄ dockets ----
    "Docket total":"小票合计", "Docket / invoice no.":"小票 / 发票号",
    "✔ Checked in at the back door":"✔ 后门已点收",
    "Typed up from the paper":"照着纸手工录的",
    "Not checked in against a delivery":"没有对应的送货点收记录",
    "Everything on this docket was counted off the truck and matched.":"这张小票上的东西都当场从车上点过，数量对得上。",
    "Open the delivery →":"打开这次送货 →",
    // ---- Chasing money back on a bad delivery ----
    "still to get back":"还没要回来",
    "💸 Chase it":"💸 去追这笔", "💸 Update the claim":"💸 更新追讨进度",
    "💸 Chasing this delivery":"💸 追这次送货的钱",
    "📌 Still to raise":"📌 还没跟他们提", "📞 Raised with them":"📞 已经跟他们提了",
    "✅ Settled":"✅ 已解决", "✖️ Written off":"✖️ 不追了",
    "Still to raise":"还没跟他们提", "Raised with them":"已经跟他们提了", "Written off":"不追了", "Settled":"已解决",
    "Money being chased":"正在追的钱", "nothing to refund":"没有要退的钱",
    "What you're chasing":"你要追多少", "Where it's up to":"进展到哪了",
    "What they said":"他们怎么说",
    "e.g. Kim will credit it on the next invoice":"例如：Kim 说下张发票里扣掉",
    "One claim is still open":"还有 1 笔没追回来",
    "Open the delivery to log what they said, or mark it settled once the credit lands.":"点开那次送货记下他们怎么说；钱到了就标成已解决。",
    "Nothing on this docket was charged for and unusable, so there's no refund to ask for. Track it here anyway if they owe you a replacement.":"这张小票上没有「收了钱又不能用」的东西，所以没有钱可退。如果他们答应补货，也可以在这里记着。",
    "One line came up short":"有 1 行少送了",
    "You were only charged for what turned up, so there's nothing to refund here. Check their monthly statement bills it the same way.":"你只按实到的数量付了钱，所以这里没有要退的。记得核对他们月结单上也是按实到算的。",
    "Claim updated":"追讨进度已更新",
    // ---- Monthly statement reconciliation ----
    "Which month":"对哪个月", "📋 Check their statement":"📋 对账单",
    "Tick every docket that appears on their statement. Leave the ones they haven't billed yet.":"他们账单上有哪几张，就勾哪几张。他们还没开账的，别勾。",
    "What their statement says":"他们账单上的总额",
    "the one total on their paperwork":"他们那张纸上的那个总数",
    "Your dockets, ticked":"你勾选的小票合计",
    "Type their total above and the gap appears here.":"在上面填他们的总额，差多少就会显示在这里。",
    "Matches to the cent.":"分毫不差。",
    "Nothing to chase — this month is clean.":"没有要追的 —— 这个月是干净的。",
    "of your dockets isn't on their statement":"的小票没出现在他们账单上",
    "Not an error — they usually catch up next month. Worth knowing so you don't pay it twice when they do.":"不是错 —— 他们通常下个月补上。知道这件事，是为了下个月别付第二遍。",
    "they have billed that you have no docket for":"他们收了钱，但你没有对应的小票",
    "on your dockets that their statement is under":"你的小票比他们账单多出来的",
    "Ring them before this gets paid. Usually a delivery nobody wrote down, or a docket billed at a different price than the one on the paper.":"付款之前先打电话。多半是有一次送货没人记下来，或者同一张小票他们按别的价格开的账。",
    "They've undercharged against what you ticked. Check you ticked the right dockets before you celebrate.":"按你勾选的算，他们少收了。先确认勾对了小票，再高兴。",
    "Save the check":"保存对账结果", "Statement check saved":"对账结果已保存",
    "Type what their statement says first":"先填他们账单上的总额",
    "e.g. rang Kim, credit coming for the short crate":"例如：已打给 Kim，少送那箱会退款",
    "no number":"无单号",
    // ---- Waste / the bin ----
    "🗑 Threw it out":"🗑 倒掉了", "Threw it out":"倒掉了", "Record the waste":"记下来",
    "Why":"为什么", "On shelf":"货架上", "Binned":"倒掉",
    "What it cost you":"这些倒掉的钱",
    "📅 Out of date":"📅 过期了", "🥀 Spoiled or off":"🥀 坏了 / 变味",
    "🔥 Prep error / burnt":"🔥 做坏了 / 烧糊了", "💥 Dropped or damaged":"💥 摔了 / 弄坏了",
    "↩️ Sent back by a customer":"↩️ 客人退回来的", "🗑 Other":"🗑 其他",
    "Write down what went in the bin and why. This takes it off your stock straight away, and it's the only way the forecast can tell what you cooked from what you threw away.":"把倒掉的东西和原因记下来。记完库存立刻扣减 —— 这也是预测能分清「做掉的」和「倒掉的」的唯一办法。",
    "Nothing recorded":"没记录任何东西",
    "e.g. fridge door left open overnight":"例如：冰箱门昨晚没关严",
    "That's stock you paid for and sold none of. It's inside the usage figures below, not on top of them.":"这些是你花钱买了、但一分钱没卖出去的货。它已经算在下面的用量里了，不是额外再加一笔。",
    "went in the bin rather than into a dish. The daily rate above deliberately still counts it — you have to buy it either way.":"是倒掉的，不是做成菜的。上面的每日用量特意仍然把它算进去 —— 反正这些你都得照买。",
    "went in the bin in the last 30 days":"在最近 30 天倒进了垃圾桶",
    "This may already be waiting at the back door":"这批货可能已经在后门等着点收了",
    "Checking it in there files the docket and moves the stock. Typing it up here as well counts the same goods twice.":"在那边点收就已经把小票归档、库存也进了。这里再录一遍，同一批货会被算两次。",
    "Check it in instead →":"改去点收 →",
    "🧾 See the docket":"🧾 看这张小票",
    "Filed as a docket":"已存为小票",
    "Signing here files the docket as well: received quantities go into stock at the prices above, and the whole thing lands in Purchases. You never type it twice.":"在这里签字等于同时把小票归档：实收数量按上面的价格进库存，整张单子进采购页。不用录第二遍。",
    "Confirming a delivery is the whole job in one go: received quantities go into stock, the prices you were charged are recorded, and the docket files itself into Purchases. Short and damaged lines are flagged for you to chase.":"点收一次把事办完：实收数量进库存、被收的价格记下来、小票自动归档到采购页。少送或破损的行会标出来给你去追。",
    "Signed · stock updated and the docket is filed":"已签收 · 库存已更新，小票已归档",
    "Already arrived":"货已经到了",
    "🚚 Expect it at the back door":"🚚 等着后门点收",
    "Deliveries are switched off":"送货功能已关闭",
    "Two ways out of here. Expect it at the back door when you\'ve just placed the order — whoever takes the delivery counts it off the truck, and the docket files itself. Already arrived is for stock that\'s standing in front of you right now.":"两条路。刚下完单就选“等着后门点收”—— 送到时谁收货谁当场点，小票自动归档。“货已经到了”是给已经摆在你面前的货用的。",
    "This adds these quantities to your stock and logs the spend against each supplier. Only do it once the delivery is actually in.":"这会把这些数量加进库存，并按供应商各记一笔支出。等货真的到了再点。",
    "came up short":"少送了", "damaged":"破损", "wrong item":"发错货",
    "counted again the same day":"同一天又盘了一次",
    "too long a gap to be meaningful":"间隔太久，没有参考意义",
    "more on the shelf than could have arrived — looks like a miscount":"货架上的比进的还多 —— 像是盘错了",
  };
  ...
  const PATTERNS = [
    ...
    [/^(.+?) goes over the (\d+)h fortnight you recorded for them\. Rostering past a work-hour condition is the venue's problem, not theirs\. This counts your number against your roster — it does not read anyone's visa, and it blocks nothing\.$/,
      m => `${m[1]} 超过了你给他记录的两周 ${m[2]} 小时上限。排超工时条件，违规的是店不是员工。这里是拿你自己填的数去比你的排班 —— 不读任何人的签证，也不拦你。`],
    [/^Work rights — visa subclass (.+)$/, m => `工作权利 — ${m[1]} 类签证`],
    [/^Expired (\d+) days? ago$/, m => `已过期 ${m[1]} 天`],
    [/^(\d+) days? left$/, m => `还剩 ${m[1]} 天`],
    [/^Expires (\d{4}-\d{2}-\d{2})$/, m => `${m[1]} 到期`],
    [/^(\d+) expired$/, m => `${m[1]} 张已过期`],
    [/^(\d+) expiring$/, m => `${m[1]} 张快到期`],
    [/^certificates? to renew$/, () => '张证件待更新'],
    [/^(\d+) h · your own figure — the roster warns above it, and blocks nothing$/,
      m => `${m[1]} 小时 · 你自己填的数，排班超了会提醒，但不拦你`],
    ...
    [/^(.+) runs out in about ([\d.]+) days\.$/, m => `${m[1]} 大约 ${m[2]} 天后用完。`],
    [/^(.+) is near the end of its shelf life\.$/, m => `${m[1]} 快过保质期了。`],
    [/^(.+) is under the level you reorder at\.$/, m => `${m[1]} 已低于补货线。`],
    // Stock / training / roster counts
    [/^([\d.]+) binned$/, m => `倒掉 ${m[1]}`],
    [/^(\d+) claims are still open$/, m => `还有 ${m[1]} 笔没追回来`],
    [/^(\d+) lines came up short$/, m => `有 ${m[1]} 行少送了`],
    [/^ordered ([\d.]+), took ([\d.]+)$/, m => `订了 ${m[1]}，实收 ${m[2]}`],
    // Live count in the label, so this needs a pattern rather than a flat key.
    // Worded as 对账单 not 核对: the Traditional file is a straight OpenCC s2t
    // pass with no exception list, and 核对 converts to the archaic 覈對.
    [/^📋 Check their statement \((\d+)\)$/, m => `📋 对账单（还有 ${m[1]} 个月）`],
    ...
    [/^use it — (\d+)-day life almost up$/, m => `快过期了 —— ${m[1]} 天保质期快到了`],
    [/^([\d.]+) (\S+) left · reorder at ([\d.]+)$/, m => `只剩 ${m[1]} ${m[2]} · 补货线 ${m[3]}`],
    [/^([\d.]+) days left$/, m => `还能撑 ${m[1]} 天`],
    [/^([\d.]+) (\S+) left$/, m => `只剩 ${m[1]} ${m[2]}`],
    // Bulk add
    [/^(\d+) items? ready$/, m => `${m[1]} 项待添加`],
    [/^(\d+) items? ready · (\d+) need a name$/, m => `${m[1]} 项待添加 · ${m[2]} 项还没名字`],
    [/^(\d+) items? added$/, m => `已添加 ${m[1]} 项`],
    // Dockets
    [/^([\d.]+) (\S+) × (\$[\d,.]+)$/, m => `${m[1]} ${m[2]} × ${m[3]}`],
    [/^▲ ([\d.]+%) vs (\$[\d,.]+) on (.+)$/, m => `▲ ${m[1]}，${m[3]} 那次是 ${m[2]}`],
    [/^▼ ([\d.]+%) vs (\$[\d,.]+) on (.+)$/, m => `▼ ${m[1]}，${m[3]} 那次是 ${m[2]}`],
    [/^same price as (.+)$/, m => `和 ${m[1]} 同价`],
    [/^Taken in by (.+)$/, m => `${m[1]} 收的货`],
    [/^\+ (\d+) more lines?$/, m => `还有 ${m[1]} 行`],
    [/^🧾 (.+) · (\d+) dockets?$/, m => `🧾 ${m[1]} · ${m[2]} 张小票`],
    [/^🧾 Their dockets \((\d+)\)$/, m => `🧾 他家的小票（${m[1]} 张）`],
    [/^No dockets from (.+) yet$/, m => `${m[1]} 还没有小票`],
    // Prices
    [/^The same (\d+) items? you bought this (week|fortnight|month) would have cost (\S+) at last (?:week|fortnight|month)'s prices — you paid (\S+)\.$/,
      m => `这${m[2]==='week'?'周':(m[2]==='fortnight'?'两周':'个月')}买的这 ${m[1]} 样东西，按上一期的价格是 ${m[3]}，实际付了 ${m[4]}。`],
    [/^That is ([+−]\S+) on the (week|fortnight|month)'s shopping \(([+-]?[\d.]+%)\)\. (\d+) went up, (\d+) came down\.$/,
      m => `也就是这一期进货${m[1].startsWith('+')?'多花':'少花'}了 ${m[1].slice(1)}（${m[3]}）。${m[4]} 样涨价，${m[5]} 样降价。`],
    [/^No change overall\. (\d+) went up, (\d+) came down\.$/, m => `总体没变化。${m[1]} 样涨价，${m[2]} 样降价。`],
    ...
    [/^Record purchases for two (week|fortnight|month)s in a row and this page tells you exactly which ingredients moved, and what that did to the bill\.$/,
      m => `连着两${m[1]==='week'?'周':(m[1]==='fortnight'?'个两周':'个月')}把小票录进来，这页就能告诉你到底哪样菜变了价、让你多花了多少。`],
    [/^No purchases in the last (\d+) days\. Record your dockets and prices start comparing themselves\.$/,
      m => `最近 ${m[1]} 天没有采购记录。把小票录进来，价格自己就开始比了。`],
    [/^same money as last (week|fortnight|month)$/, m => `和上一期一样的价`],
    [/^only appears on one (week|fortnight|month)'s dockets$/, m => `只在其中一期的小票上出现过`],
    // Forecast
    [/^Your last count was (.+) · (\d+) counts? on file\.$/, m => `最近一次盘点是 ${m[1]} · 已有 ${m[2]} 次盘点记录。`],
    [/^(.+), most recently:$/, m => `${m[1]}，最近这一次：`],
    [/^counted (.+)$/, m => `${m[1]} 盘点`],
    [/^arrived on (\d+) dockets?$/, m => `${m[1]} 张小票进的货`],
    [/^used over ([\d.]+) days$/, m => `${m[1]} 天里用掉`],
    // The kind emoji shares the text node with the caption, so it has to be
    // captured and put back rather than matched around.
    [/^(\S+) measured across (\d+) stretch(?:es)? between counts$/, m => `${m[1]} 由 ${m[2]} 段盘点区间算出`],
    [/^(\S+) no usage data yet$/, m => `${m[1]} 还没有用量数据`],
    [/^([\d.]+) days · (\d+) deliver(?:y|ies)$/, m => `${m[1]} 天 · ${m[2]} 次送货`],
    ...
    [/^There's no till in this app, so nobody can deduct an ingredient per dish\. Instead usage is what the shelf actually shows:$/,
      "这个 App 没有收银机，所以没人能按每道菜去扣原料。用量只看货架上真实发生的事："],
    ...
    [/^That week worked out at ([\d.]+) (\S+) a day\. Averaged with every other count, it settles at ([\d.]+) a day — at ([\d.]+) \2 on the shelf, that's ([\d.]+) days before it runs out\.$/,
      m => `那一周算下来是每天 ${m[1]} ${m[2]}。和其他几次盘点平均后是每天 ${m[3]} —— 按货架上的 ${m[4]} ${m[2]}，还能撑 ${m[5]} 天。`],
    [/^What they bring · (\d+) to order$/, m => `他家送这些 · ${m[1]} 样该订了`],
    [/^⚠ ordered ([\d.]+) (\S+), took ([\d.]+)$/, m => `⚠ 订了 ${m[1]} ${m[2]}，实收 ${m[3]}`],
    [/^⚠ ordered ([\d.]+) (\S+), took ([\d.]+) · (.+)$/, m => `⚠ 订了 ${m[1]} ${m[2]}，实收 ${m[3]} · ${tr(m[4])}`],
    [/^(.+) counted it off the truck$/, m => `${m[1]} 当场从车上点的`],
    [/^(.+) counted it off the truck · ([\d.-]+)°C on arrival$/, m => `${m[1]} 当场从车上点的 · 到货 ${m[2]}°C`],
    [/^(\d+) line was short or damaged when this arrived — worth checking before you pay the invoice\.$/,
      m => `到货时有 ${m[1]} 行少送或破损 —— 付款前值得先核对一下。`],
    [/^(\d+) lines were short or damaged when this arrived — worth checking before you pay the invoice\.$/,
      m => `到货时有 ${m[1]} 行少送或破损 —— 付款前值得先核对一下。`],
    [/^(\d+) delivery\(ies\) waiting at the back door$/, m => `${m[1]} 车货在后门等着点收`],
    [/^Waiting at the back door for (.+)$/, m => `${m[1]} 的货已排进后门点收`],
    [/^What they bring$/, "他家送这些"],
    [/^Comparing (.+) – (.+) against (.+) – (.+)\.$/, m => `对比区间：${m[1]} – ${m[2]} 对上 ${m[3]} – ${m[4]}。`],
    [/^↩ was (\$[\d,.]+) at (.+) on (.+) · (\$[\d,.]+) on this (week|fortnight|month)'s quantity$/,
      m => `↩ ${m[3]} 在 ${m[2]} 是 ${m[1]} · 按这一期的量能差 ${m[4]}`],
    [/^↩ they charged (\$[\d,.]+) on (.+) · (\$[\d,.]+) on this (week|fortnight|month)'s quantity$/,
      m => `↩ ${m[2]} 他家收的是 ${m[1]} · 按这一期的量能差 ${m[3]}`],
