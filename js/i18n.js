...
(function(){
  ...
  const T = {
    ...
    "🧺 Fill the basket for me":"🧺 帮我把要补的都装上",
    "🧊 Cold room":"🧊 冷库", "fresh food — the clock is running":"生鲜 —— 会坏，时间在走",
    "🧺 Dry store":"🧺 干货区", "tools and consumables — counted, never goes off":"工具与耗材 —— 只盘点，不会坏",
    "Nothing on this shelf yet — add an item and it shows up here.":"这排货架还是空的 —— 添加物品后就会出现在这里。",
    "Tap a jar to look at it · tap":"点罐子看详情 · 点",
    "to drop it straight in the basket":"直接丢进篮子",
    "in the basket":"样在篮子里", "Open the order →":"打开订单 →",
    "Nothing needs topping up":"没有需要补的",
    "Running out":"快没了", "Getting low":"不多了", "Well stocked":"库存充足",
    "Days of cover":"还能撑几天", "Used per day":"每天用量", "Last price paid":"最近采购价",
    "needs 2 stocktakes":"需要盘点两次", "not set":"未设置",
    "Order how much?":"订多少？",
    "Or just counted it? Type what's really there":"顺手盘点了？填现在实际有多少",
    "Counting is the only place usage comes from — there's no till in this app.":"用量只能来自盘点 —— 这个 App 没有收银机。",
    "Save count":"保存盘点", "Type what you counted":"请填写盘点数量",
    "Edit item":"编辑物品", "Put in the basket":"放进篮子",
    "Removed from the basket":"已从篮子移除", "The basket is empty":"篮子是空的",
    "Nothing in the basket":"篮子里没有东西",
    "🧺 The basket":"🧺 篮子", "Empty it":"清空", "Record as purchase":"记为已采购",
    "Empty the basket":"清空篮子",
    "Clear everything you picked off the shelves?":"把从货架上拿的东西全部清掉？",
    "Basket emptied":"篮子已清空", "Record it":"确认记录",
    "Purchase recorded · stock topped up":"采购已记录 · 库存已补上",
    "No supplier set":"未设供应商",
    "“Record as purchase” logs it against each supplier, adds the quantities to stock and updates the price trend — the same as the Purchases tab, just from here.":"“记为已采购”会按供应商各记一笔、把数量加进库存、并更新价格涨跌 —— 和采购页效果一样，只是从这里下手。",
    "Needs you today":"今天要处理", "🧺 Basket the lot":"🧺 全部装进篮子",
